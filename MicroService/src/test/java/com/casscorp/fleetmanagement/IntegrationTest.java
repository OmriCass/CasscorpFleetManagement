...
import com.casscorp.fleetmanagement.MicroServiceApp;
...
@SpringBootTest(classes = { MicroServiceApp.class, AsyncSyncConfiguration.class, TestSecurityConfiguration.class })
